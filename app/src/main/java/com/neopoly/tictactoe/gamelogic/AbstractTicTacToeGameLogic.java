 ...
 * construction of printable game state representations.
 */
            ...
            if (fieldCountOfFirstGamer == fieldCountOfSecondGamer
                ...
                try {
                    ...
                    for (int round = 0; round < fieldCountOfSecondGamer; round++) {
                        setSignToField(fieldIndicesOfFirstGamer[round]);
                        returnValue = setSignToField(fieldIndicesOfSecondGamer[round]);
                    }
                    if (fieldCountOfFirstGamer > fieldCountOfSecondGamer) {
                        returnValue = setSignToField(
